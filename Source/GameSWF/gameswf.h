...
namespace gameswf
{
	...
	sound_handler*	create_sound_handler_psp();
	sound_handler*	create_sound_handler_sdl();
	render_handler*	create_render_handler_psp();
	...
	struct render_handler
	{
		...
		virtual bitmap_info*	create_bitmap_info_rgb(image::rgb* im, bool resize) = 0;
		...
		virtual bool	is_on_screen(const void * coords, int vertex_count) = 0;
		virtual void	draw_mesh_strip(const void* coords, int vertex_count) = 0;
		virtual void	draw_mesh_strip(const void* coords, int vertex_count, const bitmap_info * const p_bitmap ) = 0;
