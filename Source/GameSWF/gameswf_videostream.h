// gameswf_videostream.h	-- Thatcher Ulrich <tu@tulrich.com> 2003

// This source code has been donated to the Public Domain.  Do
// whatever you want with it.


#ifndef GAMESWF_VIDEOSTREAM_H
#define GAMESWF_VIDEOSTREAM_H
...
namespace gameswf
{
	...
	//
  	// videostream_instance
  	//
  	struct video_instance : public character
  	{
  		...
  		video_instance(movie_definition_sub* def, movie_root* r, movie* parent, int id);
	...
	// video_definition
	//
	struct video_definition : public movie_definition_sub
	{
		enum eCodec
		{
			CODEC_SORENSON		= 2,
			CODEC_SCREEN_VIDEO	= 3,
		};
		...
		array< sVideoFrame >		m_Frames;

		bitmap_info *				m_pBitmap;
		...
		video_definition(movie_definition_sub* m);
		...
		void							read(stream* in);
		void							add_frame( stream * in );
		bool							decode_frame( s32 frame_num );
	};
